...
@ContextConfiguration({"classpath:META-INF/spring/property-source-placeholder-configurer-test-context.xml"})
@RunWith(SpringJUnit4ClassRunner.class)
public class CombinePropertySourcesPlaceholderConfigurerTest {
